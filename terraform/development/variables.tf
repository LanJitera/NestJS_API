...
variable "database_name" {
  ...
  default     = "party_booking_app_development"
}
...
variable "domain" {
  description = "Domain"
  default     = "party-booking-app-development.project.jitera.app"
}
...
variable "bucket_name" {
  default = "party-booking-app-development-storage"
}
