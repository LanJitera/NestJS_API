...
export class OAuthController {
  ...
  @Post('api/admins_verify_confirmation_token')
  @HttpCode(HttpStatus.OK)
  async verifyAdminConfirmationEmail(
    @Body() body: VerifyConfirmationDTO,
  ): Promise<TokenResponseDTO> {
    return this.oauthService.verifyAdminConfirmationEmail(body.confirmation_token);
  }
