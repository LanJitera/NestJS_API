...
export class AdminController {
  ...
  show(
    @Param() params: ShowAdminParamsDTO,
    @Query() queries: ShowAdminRequestDTO,
  ): Promise<ShowAdminResponseDTO> {
    return this.adminService.show(params, queries);
  }
  ...
  delete(
    @Param() params: DeleteAdminParamsDTO,
    @Body() request: DeleteAdminRequestDTO,
  ): Promise<DeleteAdminResponseDTO> {
    return this.adminService.delete(params, request);
  }
}
